...
SOURCE_URL = "https://live-tennis.eu/en/wta-live-ranking"
FALLBACK_URL = "https://r.jina.ai/http://live-tennis.eu/en/wta-live-ranking"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Fetch WTA live rankings into CSV.")
    parser.add_argument("--out", default="data/wta_live_ranking.csv", help="Output CSV path")
