    ...
    <div class="player-hero-head">
      ...
      <div>
        ...
        <div class="player-meta-line">
          ...
          ${player.profileUrl ? `<span>•</span><a href="${escapeHtml(player.profileUrl)}" target="_blank" rel="noopener noreferrer">ATP Profile</a>` : ''}
        </div>
      </div>
    </div>
  `;
...
function renderPlayerRanking() {
  ...
  if (window.Plotly && dom.rankingChart) {
    ...
    const layout = {
      ...
      yaxis: {
        title: { text: 'ATP Ranking (Lower is better)', standoff: 12 },
        visible: showRank,
        automargin: true,
        autorange: 'reversed',
